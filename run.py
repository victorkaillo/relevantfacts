...
from webapp.services.relevantFactsService import tableRelevantFacts, tableRelevantFactsToday
from webapp.services.sqlServerConnectionService import executeDeleteAno, getByFilterjson, getAllRelevantFactsjson
